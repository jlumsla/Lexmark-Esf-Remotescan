...
public class SetDeviceContextServlet extends HttpServlet
{
   // Eclipse gives a warning if this is not there
   private static final long serialVersionUID = 1L;

   public SetDeviceContextServlet()
   {
   }
         ...
         HttpServletResponse response) throws ServletException, IOException
   {
      ...
      System.out.println("Executing SetDeviceContextServlet");
      ...
      out.append("<SetDeviceContextResponse/>");
      out.append("</result>");  
   }
