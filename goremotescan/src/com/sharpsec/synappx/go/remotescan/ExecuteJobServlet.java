...
public class ExecuteJobServlet extends HttpServlet
{
   ...
   {
      System.out.println("Executing ExecuteJobServlet");
      
      ServiceBinderContext sbc = null;
      BasicProfileContext context = null;
      
      ScanToHttpProfile scanToHttpProfile = new ScanToHttpProfile(sbc);
      try 
      {
         scanToHttpProfile.go(context);
      }
      catch (Exception e)
      {
         Activator.getLog().info("Error in scanToHttpProfile");
      }
      ...
      out.append("<ExecuteJobResponse>");
      out.append("<jobId>").append("123456").append("</jobId>");
      out.append("</ExecuteJobResponse>");
      out.append("</result>");  
   }
