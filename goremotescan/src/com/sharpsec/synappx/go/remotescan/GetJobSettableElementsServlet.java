...
public class GetJobSettableElementsServlet extends HttpServlet
{
   // Eclipse gives a warning if this is not there
   private static final long serialVersionUID = 1L;

   public GetJobSettableElementsServlet()
   {
   }
         ...
         HttpServletResponse response) throws ServletException, IOException
   {
      ...
      System.out.println("Executing GetJobSettableElementsServlet");
      ...
      out.append("<GetJobSettableElementsResponse/>");
      out.append("</result>");  
   }
