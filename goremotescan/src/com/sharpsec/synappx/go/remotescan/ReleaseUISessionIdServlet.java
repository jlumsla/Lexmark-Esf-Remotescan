...
public class ReleaseUISessionIdServlet extends HttpServlet
{
   // Eclipse gives a warning if this is not there
   private static final long serialVersionUID = 1L;

   public ReleaseUISessionIdServlet()
   {
   }
         ...
         HttpServletResponse response) throws ServletException, IOException
   {
      ...
      System.out.println("Executing ReleaseUISessionIdServlet");
      ...
      out.append("<ReleaseUISessonIdResponse/>");
      out.append("</result>");  
   }
